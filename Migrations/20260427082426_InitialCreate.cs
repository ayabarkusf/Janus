        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareerInterest = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetricValue = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsTaught = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Opportunities_AspNetUsers_HostUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpportunityApplications_AspNetUsers_StudentUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Opportunities_HostUserId",
                table: "Opportunities",
                column: "HostUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpportunityApplications_StudentUserId_OpportunityId",
                table: "OpportunityApplications",
